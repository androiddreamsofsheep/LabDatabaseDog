...
public class DogsAdapter
        extends CursorRecyclerViewAdapter<DogsAdapter.ViewHolder> {

    private OnItemClickListener onItemClickListener;

    public DogsAdapter(Context context, Cursor cursor) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, Cursor cursor) {
        ...
        long id = cursor.getLong(cursor.getColumnIndex(Dog.COLUMN_ID));
        String name = cursor.getString(cursor.getColumnIndex(Dog.COLUMN_NAME));
